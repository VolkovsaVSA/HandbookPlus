...
extension UnitEnergy {
    ...
    static let horsepower = UnitEnergy(symbol: NSLocalizedString("hp", comment: "horsepower symbol"), converter: UnitConverterLinear(coefficient: 2647795.5))
    ...
    static let newtonMeter = UnitEnergy(symbol: NSLocalizedString("kW•s", comment: "newtonMeter symbol"), converter: UnitConverterLinear(coefficient: 1000))
