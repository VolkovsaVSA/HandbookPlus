...
""", comment: "UnitTypeDescription")
    var units: [UnitCalcModel] = [
        ...
        UnitCalcModel(title: NSLocalizedString("Kilometers per second squared", comment: "kilometerPerSecondSquared title"),
                      ...
                      unitDescription: NSLocalizedString("A kilometer per second squared is a unit of acceleration in the International System of Units (SI), equal to 1000 m/с². Physical interpretation: if an object accelerates at 1 km/s², its speed is increasing by 1 km/s every second.", comment: "kilometerPerSecondSquared unitDescription")),
        UnitCalcModel(title: NSLocalizedString("Millimeters per second squared", comment: "millimeterPerSecondSquared title"),
                      ...
                      unitDescription: NSLocalizedString("A millimeter per second squared is a unit of acceleration in the International System of Units (SI), equal to 0.001 m/с². Physical interpretation: if an object accelerates at 1 mm/s², its speed is increasing by 1 mm/s every second.", comment: "millimeterPerSecondSquared unitDescription")),
        UnitCalcModel(title: NSLocalizedString("Yard per second squared", comment: "yardPerSecondSquared title"),
                      ...
                      unitDescription: NSLocalizedString("A yard per second squared is a unit of acceleration in the British (Imperial) and US customary systems, equal to 0.9144 m/с². Physical interpretation: if an object accelerates at 1 yd/s², its speed is increasing by 1 yd/s every second.", comment: "yardPerSecondSquared unitDescription")),
        UnitCalcModel(title: NSLocalizedString("Foot per second squared", comment: "feetPerSecondSquared title"),
                      ...
                      unitDescription: NSLocalizedString("A foot per second squared is a unit of acceleration in the British (Imperial) and US customary systems, equal to 0.3048 m/с². Physical interpretation: if an object accelerates at 1 ft/s², its speed is increasing by 1 ft/s every second.", comment: "feetPerSecondSquared unitDescription")),
        UnitCalcModel(title: NSLocalizedString("Inches per second squared", comment: "inchPerSecondSquared title"),
                      ...
                      unitDescription: NSLocalizedString("An inch per second squared is a unit of acceleration in the British (Imperial) and US customary systems, equal to 0.0254 m/с². Physical interpretation: if an object accelerates at 1 in/s², its speed is increasing by 1 in/s every second.", comment: "inchPerSecondSquared unitDescription")),
        UnitCalcModel(title: NSLocalizedString("Gravity", comment: "gravity title"),
                      unit: UnitAcceleration.gravity,
                      unitDescription: NSLocalizedString("The gravity of Earth, which is denoted by g, refers to the acceleration that the Earth imparts to objects on or near its surface. In SI units this acceleration is measured in meters per second squared (in symbols, m/s2) or equivalently in newtons per kilogram (N/kg). It has an approximate value of 9.81 m/s2, which means that ignoring the effects of air resistance, the speed of an object falling freely near the Earth's surface will increase by about 9.81 meters (32.2 ft) per second every second. This quantity is sometimes referred to informally as little g (in contrast, the gravitational constant G is referred to as big G).", comment: "gravity unitDescription")),
